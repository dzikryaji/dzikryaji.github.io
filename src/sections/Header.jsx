...
const Header = () => {
  ...
  return (
    <motion.div
      className={`fixed top-0 left-0 w-full z-50 border-b border-inherit bg-inherit`}o
      variants={{
        visible: { y: 0 },
        hidden: { y: "-100% " }
      }}
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        <nav className={`${openNavigation ? 'flex bg-bone' : 'hidden'} fixed top-[4.4rem] left-0 right-0 bottom-0 bg-n-8 lg:static lg:flex lg:mx-auto lg:bg-transparent`}>
